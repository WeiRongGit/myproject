...
<html>
    ...
    <body>
        ...
        <div style="font-size: 13px;margin: 10px 5px">
            ...
            <form action="/730/shop/index.php/Admin/Manager/add" method="post" enctype="multipart/form-data">
            <table border="1" width="100%" class="table_a">
                ...
                <tr>
                    <td>管理员角色</td>
                    <td> <select id="" name="mg_role_id" onchange="" ondblclick="" class="" ><?php  foreach($role as $key=>$val) { ?><option value="<?php echo $key ?>"><?php echo $val ?></option><?php } ?></select></td>
                </tr>
