...
<html>
    <head>
        ...
        <link href="/730/shop/Public__css__admin.css" type="text/css" rel="stylesheet" />
    </head>
    <body>
        <table cellspacing=0 cellpadding=0 width="100%" align=center border=0>
            <tr height=28>
                <td background=/730/shop/Public/Admin/Images/title_bg1.jpg>当前位置: </td></tr>
            <tr>
                <td bgcolor=#b1ceef height=1></td></tr>
            <tr height=20>
                <td background=/730/shop/Public/Admin/Images/shadow_bg.jpg></td></tr></table>
        <table cellspacing=0 cellpadding=0 width="90%" align=center border=0>
            <tr height=100>
                <td align=middle width=100><img height=100 src="/730/shop/Public/Admin/Images/admin_p.gif" 
                                                width=90></td>
                <td width=60>&nbsp;</td>
                <td>
                    <table height=100 cellspacing=0 cellpadding=0 width="100%" border=0>
                        ...
                        <tr>
                            <td style="font-weight: bold; font-size: 16px"><?php echo ($_SESSION['user']['mg_name']); ?></td></tr>
                        <tr>
        ...
        <table cellspacing=0 cellpadding=0 width="95%" align=center border=0>
            ...
            <tr height=22>
                <td style="padding-left: 20px; font-weight: bold; color: #ffffff" 
                    align=middle background=/730/shop/Public/Admin/CSS/title_bg2.jpg>您的相关信息</td></tr>
